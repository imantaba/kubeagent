...
func usageError() error {
	return fmt.Errorf("usage: %[1]s scan [--kubeconfig path] [--context name] [-n namespace] [--output text|json|html] [--explain] [--investigate] [--model name] [--include-cron] [--include-restarts] [--pvc-reclaim] [--lint-secrets] [--security] [--security-verbose] [--disk-usage [--disk-threshold r]] [--kubelet-health] [--control-plane-health] [--dns-health] [--certs [--cert-warn-days n]] [--operators] [--drift] [--drift-age dur] [--capacity] [--policy path (repeatable)] [--policy-pack name (repeatable)] [--baseline path] [--baseline-factor n] [--baseline-floor n] [--logs] [--node-heartbeat-threshold dur] [--expected-nodes a,b,…] [--suggest] [--fix [--dry-run|--yes] [--audit-log path]] [--rollback --audit-log path] | %[1]s watch [--kubeconfig path] [--context name (repeatable)] [--cluster-name name] [--include-local] [-n namespace] [--metrics-addr addr] [--heartbeat dur] [--debounce dur] [--alert-format json|slack|alertmanager|pagerduty] [--alert-repeat dur] [--slo-target pct] [--dashboard] [--explain [--explain-cooldown dur] [--explain-budget n] [--model name]] | %[1]s mcp [--kubeconfig path] [--context name] [--allow-context-switch] [--logs] | %[1]s gate [--kubeconfig path] [--context name] [-n namespace] [--wait-for kind/name] [--timeout dur] [--poll-interval dur] [--fail-on critical|warning|info] [--allow-partial-read resource (repeatable)] [--policy path (repeatable)] [--policy-pack name (repeatable)] [--baseline path] [--baseline-factor f] [--baseline-floor f] [--output text|json|sarif] | %[1]s fleet [--kubeconfig path] [--context name (repeatable)] [--all-contexts] [--match glob] [--fleet-file path] [--fail-on critical|warning|info] [--workers n] [--cluster-timeout dur] [--output text|json] [-n namespace] | %[1]s tui [--kubeconfig path] [--context name] [-n namespace] | %[1]s rbac print [--profile scan|watch|full] [--features a,b,…] [--role-name name] [--output yaml|json] | %[1]s rbac check [--kubeconfig path] [--context name] [--profile scan|watch|full] [--features a,b,…] [--output text|json] | %[1]s policy validate <file>… | %[1]s policy packs [--print name] | %[1]s baseline capture [--kubeconfig path] [--context name] [-n namespace] [--min-pod-age dur] | %[1]s schema [name] | %[1]s known-issues [kind] | %[1]s version | %[1]s completion bash|zsh|fish|powershell", invokedAs)
}
